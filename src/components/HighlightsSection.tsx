  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        <h2 id="highlights-heading" className="text-2xl md:text-3xl font-bold text-white mb-8">
          Why stay with us
        </h2>
        <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {highlights.map((item, i) => (
            <li
              key={i}
              className="glass-card card-glow card-glow-hover flex items-start gap-4 p-4 rounded-xl transition-shadow duration-300"
            >
